...
export default function Footer() {
  return (
    <footer style={{ background: 'var(--dark-1)', borderTop: '0.5px solid var(--border)' }} className="py-16">
      <div className="mx-auto w-full max-w-6xl px-8 md:px-20 grid grid-cols-1 gap-12 md:grid-cols-3">
        <div>
      ...
      <div className="mx-auto w-full max-w-6xl px-8 md:px-20 mt-12 pt-6 text-center text-[10px] uppercase tracking-[0.3em]" style={{ borderTop: '0.5px solid var(--border)', color: 'rgba(200,192,175,0.25)' }}>
